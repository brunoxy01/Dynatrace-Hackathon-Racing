> **Notas históricas de exploração.** A arquitetura OTel, ferramentas auxiliares e pendências abaixo não descrevem necessariamente o estado atual deste repositório. O app oficial usa Business Events/Grail; consulte o [README atual](README.md). Este merge adiciona ferramentas UDP e não altera nem republica o app.
