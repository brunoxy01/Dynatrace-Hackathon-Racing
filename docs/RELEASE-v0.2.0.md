...
- Três pilotos sintéticos adicionais com empresas e ritmos distintos; dados de teste explicitamente identificados.
- Mapa combinado automático: velocidade azul, frenagem vermelha e aceleração verde.
...
Validação: 8 testes do frontend, testes Python do protocolo e replay, lint e build aprovados. Replay completo conferido no navegador.
